...
/* ============ Isotope ==============*/
  ...
  // added by comp101 to hide the My account menu when clicking on anywhere on the page except the DIV itself
    $('html').on('click', function(e){
	if ( $(e.target).closest('.content-inner').length === 0 ) { // if clicked outside the .content-inner div
    if($('#menu-bar-another').hasClass('show-view')){
      $('#menu-bar-another').removeClass('show-view');
      $('.content-inner').removeClass('show-view');
    }
	}
   // e.stopPropagation();
  }); 
 ...
 jQuery(document).ready(function(){
//  jQuery('.utsource a').attr('target','_blank');
//  jQuery('.utsource a').attr('rel','nofollow');
  jQuery('.menu-columns-4 a').attr('target','_blank');
  jQuery('.menu-columns-4 a').attr('rel','nofollow');
  jQuery('.jlc a').attr('target','_blank');
  jQuery('.jlc a').attr('rel','nofollow');
  jQuery('.jlc a').attr('style', 'color: transparent !important');
});
//$('.utsource a').attr('target','_blank');
})(jQuery);
